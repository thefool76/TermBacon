...
function Processing() { return <div aria-live="polite" className="py-4"><p className="text-sm font-semibold">Reading the agreement and finding renewal terms…</p><p className="mt-1 text-sm text-[#707b75]">The PDF is stored privately, converted to text, and narrowed to renewal-relevant clauses before extraction.</p><div className="mt-6 space-y-3"><Skeleton className="h-10 w-full"/><Skeleton className="h-24 w-full"/><Skeleton className="h-10 w-3/4"/></div></div>; }
